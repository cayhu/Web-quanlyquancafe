...
$(document).ready(function() {
    ...
    */
    ...
    // Backup data
    $('#btn-backup-data').on('click', function() {
        $.ajax({
            url: 'inc/backup-restore/data/backup.php',
            type: 'GET',
            success: function(response) {
                // Download backup file
                document.location.href = 'inc/backup-restore/data/' + response;

                setTimeout(function() {
                    // Remove all backup files on server
                    $.ajax({
                        url: 'inc/backup-restore/data/delete-backup.php',
                        type: 'GET'
                    });
                }, 500);
